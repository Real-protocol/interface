...
const uniLink = (lusdAddress: string) =>
  `https://swap.puffydao.com/#/swap?inputCurrency=${lusdAddress}&outputCurrency=ETH`;
        ...
        <Card>
          <Box sx={{ p: [2, 3] }}>
            <InfoMessage title="Bot functionality">
              ...
              <Paragraph sx={{ mt: 2 }}>
                Most of the time you will get a better rate for converting USDW to ETHW on{" "}
                <Link href={uniLink(addresses["lusdToken"])} target="_blank">
                  Puffyswap <Icon name="external-link-alt" size="xs" />
                </Link>{" "}
                or other exchanges.
              </Paragraph>
              <Paragraph sx={{ mt: 2 }}>
